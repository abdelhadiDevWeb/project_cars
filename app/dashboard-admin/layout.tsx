        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
            {[
              ...
              { name: 'Véhicules', icon: 'car', path: '/dashboard-admin/vehicles' },
              { name: 'Inspections', icon: 'inspection', path: '/dashboard-admin/inspections' },
              { name: 'Ateliers Partenaires', icon: 'workshop', path: '/dashboard-admin/workshops' },
              { name: 'Messagerie', icon: 'message', path: '/dashboard-admin/messages' },
              { name: 'Encaissements', icon: 'money', path: '/dashboard-admin/payments' },
              { name: 'Sécurité', icon: 'security', path: '/dashboard-admin/security' },
