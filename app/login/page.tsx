            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setEmail(e.target.value)}
                  className="appearance-none relative block w-full pl-16 pr-4 py-3.5 bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 placeholder-gray-400 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500/30 focus:border-teal-500 transition-all shadow-sm hover:shadow-md hover:border-teal-300"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="appearance-none relative block w-full pl-16 pr-12 py-3.5 bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 placeholder-gray-400 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500/30 focus:border-teal-500 transition-all shadow-sm hover:shadow-md hover:border-teal-300"
                  placeholder="••••••••"
                />
                <button
                  type="button"
